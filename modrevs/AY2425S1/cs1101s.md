...
For assessments there were written midterms and finals, and a practical test, which were basically 6 leetcode easy questions.
...
## Source 4
This chapter teaches us how languages work and introduces three new functions.
`tokenize`, to convert a program string into [lexical tokens](https://en.wikipedia.org/wiki/Lexical_analysis),
`parse`, to convert a program string into an [abstract syntax tree](https://en.wikipedia.org/wiki/Abstract_syntax_tree),
...
These functions are used to create a meta circular evaluator.
...
Brainfuck requires an infinite length tape. However there are no lists in Source 1,
but they can be implemented using lambdas.
...
Another cool program my friend [notmeegoreng](https://github.com/notmeegoreng/) wrote is
a game of life simulator using the *Runes* module, which allows you
