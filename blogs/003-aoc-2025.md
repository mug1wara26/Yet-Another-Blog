...
programming puzzles released every December. Previous iterations featured 25
...
distinct enough (for example, no mixing C and C++).

These were the languages I ended up using, ordered by the day I used them, the
languages in _italics_ indicate that I used them for the first time.
...
solution to another language. I also revisited some days in Uiua, as I found it
to be a very fun language to work with. My solutions are contained in this
[GitHub repo](https://github.com/mug1wara26/AOC2025), and this blog post just
goes through more of my thought process for each day.
...
approach, but imo finding ways to exploit the input is part of these puzzles.
